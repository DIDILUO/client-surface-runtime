...
export interface ContentServiceHubReminderRecord extends ContentServiceHubEntryReminderDto {}

const createRecord = (record: ContentServiceHubReminderRecord): ContentServiceHubReminderRecord => ({
  ...record,
})

export const contentServiceHubReminderSeed: Record<ContentServiceEntryId, ContentServiceHubReminderRecord> = {
  orders: createRecord({
    serviceId: 'orders',
    hasReminder: true,
    unreadCount: 1,
