<template>
  <view
    ...
    :class="{ 'is-drawer-open': isDrawerOpen, 'is-wide-rail-mode': isWideRailMode }"
    :style="scaffoldStyle"
  >
    <view class="standalone-page-scaffold-stage">
      <view class="standalone-page-scaffold-frame" :class="{ 'is-wide-rail-mode': isWideRailMode }">
        <HomeShellNavRail
          v-if="isWideRailMode"
      ...
      <HomeShellDrawer :open="isDrawerOpen" :runtime-context="runtimeContext" @close="handleDrawerClose" />
    </view>
  </view>
</template>
...
import type { HomeShellNavEntryId } from '../models/homeShellMenu.model'
import { useResponsiveRailLayout } from '../composables/useResponsiveRailLayout'
import { clearHomeShellDocumentScrollLock, syncHomeShellDocumentScrollLock } from '../services/homeShellDom.service'
import { buildHomeShellPageUrl } from '../services/homeRailNavigation.service'
import HomeShellDrawer from '../pages/home/components/HomeShellDrawer.vue'
import HomeShellNavRail from '../pages/home/components/HomeShellNavRail.vue'

interface Props {
  activeNavEntryId?: HomeShellNavEntryId
  routeSource: string
}
...
const handleChangeTab = (tab: PageKey) => {
  isDrawerOpen.value = false
  uni.redirectTo({
    url: buildHomeShellPageUrl(tab, props.routeSource),
  })
}
</script>
